...
namespace DBZMOD.Items.Consumables.TestItems
{
    public class SSJ2MasteryTestItem : ModItem
    {
        ...
        public override bool UseItem(Player player)
        {
            ...
            modPlayer.masteryLevels[TransformationHelper.SSJ2.masteryBuffKeyName] = Math.Min(1.0f, modPlayer.masteryLevels[TransformationHelper.SSJ2.masteryBuffKeyName] + 0.25f);
            return true;
