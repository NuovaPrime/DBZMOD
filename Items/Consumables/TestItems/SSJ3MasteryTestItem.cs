...
namespace DBZMOD.Items.Consumables.TestItems
{
    public class SSJ3MasteryTestItem : ModItem
    {
        ...
        public override bool UseItem(Player player)
        {
            ...
            modPlayer.masteryLevels[TransformationHelper.SSJ3.masteryBuffKeyName] = Math.Min(1.0f, modPlayer.masteryLevels[TransformationHelper.SSJ3.masteryBuffKeyName] + 0.25f);
            return true;
