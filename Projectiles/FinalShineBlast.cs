...
{
    public class FinalShineBlast : KiProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y - 0, 0, 0, mod.ProjectileType("FinalShineTrail"), projectile.damage / 3, 4f, projectile.owner, 0, projectile.rotation);
                projectile.ai[1] = 0;
                projectile.netUpdate = true;
            }
        }
