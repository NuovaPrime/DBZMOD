...
namespace DBZMOD.Effects.Animations.Aura
{
    public static class AuraAnimations
    {
        ...
        public static AuraAnimationInfo ssjgAura = new AuraAnimationInfo(AuraID.SSJG, GetAnimationSpriteName("SSJGAura"), 4, 3, BlendState.AlphaBlend, "Sounds/SSJAscension", "Sounds/SSG", 340, true, false, new AuraAnimationInfo.DustDelegate(DoChargeDust), 0, null, 1);
        public static AuraAnimationInfo ssjbAura = new AuraAnimationInfo(AuraID.SSJB, GetAnimationSpriteName("SSJBAura"), 4, 3, BlendState.Additive, "Sounds/SSJAscension", "Sounds/SSG", 340, true, false, new AuraAnimationInfo.DustDelegate(DoChargeDust), 0, null, 1);
